...
ALGORITHM='neuralRegressionGamma'
CONFIGNAME='neuralRegressionGamma.py'
...
def build_model(units_0, n_hidden, activ, cyclic, early, **kwargs):
    ...
    for i in range(1,n_hidden+1):
        ...
        keras.layers.Dense(
            ...
            activation=activ))
    #output layer
    model.add(keras.layers.Dense(1, activation=tf.keras.activations.exponential,name='output',
